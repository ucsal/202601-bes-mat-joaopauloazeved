...
public class App {
    ...
    static ParticipanteService participanteService
            = new ParticipanteService(participantes, proximoParticipanteId);
    ...
    static ProvaService provaservice = new ProvaService(provas, proximaProvaId);
